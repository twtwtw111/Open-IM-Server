...
1. cd /home/Open-IM-Server/script  && ./stop_all.sh
2. ./batch_build_all_service.sh
3. cp -r /home/Open-IM-Server/bin /root/Open-IM-Server/bin 
4. cd ../script/start_all.sh && ./check_all.sh
